...
export namespace Prisma {
  ...
  */
  ...
  export type BorrowingGroupByArgs = {
    where?: borrowingWhereInput
    orderBy?: Enumerable<borrowingOrderByInput>
    by: Array<BorrowingScalarFieldEnum>
    having?: borrowingScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    count?: BorrowingCountAggregateInputType | true
    avg?: BorrowingAvgAggregateInputType
    sum?: BorrowingSumAggregateInputType
    min?: BorrowingMinAggregateInputType
    max?: BorrowingMaxAggregateInputType
  ...
  type GetBorrowingGroupByPayload<T extends BorrowingGroupByArgs> = Promise<Array<
    PickArray<BorrowingGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof BorrowingGroupByOutputType))]: GetScalarType<T[P], BorrowingGroupByOutputType[P]>
    }
  >>
  ...
  export interface borrowingDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, BorrowingGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBorrowingGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type DiscussGroupByArgs = {
    where?: discussWhereInput
    orderBy?: Enumerable<discussOrderByInput>
    by: Array<DiscussScalarFieldEnum>
    having?: discussScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    count?: DiscussCountAggregateInputType | true
    avg?: DiscussAvgAggregateInputType
    sum?: DiscussSumAggregateInputType
    min?: DiscussMinAggregateInputType
    max?: DiscussMaxAggregateInputType
  ...
  type GetDiscussGroupByPayload<T extends DiscussGroupByArgs> = Promise<Array<
    PickArray<DiscussGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof DiscussGroupByOutputType))]: GetScalarType<T[P], DiscussGroupByOutputType[P]>
    }
  >>
  ...
  export interface discussDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {DiscussGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends DiscussGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: DiscussGroupByArgs['orderBy'] }
        : { orderBy?: DiscussGroupByArgs['orderBy'] },
      OrderFields extends Keys<MaybeTupleToUnion<T['orderBy']>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, DiscussGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDiscussGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type User_detailGroupByArgs = {
    where?: user_detailWhereInput
    orderBy?: Enumerable<user_detailOrderByInput>
    by: Array<User_detailScalarFieldEnum>
    having?: user_detailScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    count?: User_detailCountAggregateInputType | true
    avg?: User_detailAvgAggregateInputType
    sum?: User_detailSumAggregateInputType
    min?: User_detailMinAggregateInputType
    max?: User_detailMaxAggregateInputType
  ...
  type GetUser_detailGroupByPayload<T extends User_detailGroupByArgs> = Promise<Array<
    PickArray<User_detailGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof User_detailGroupByOutputType))]: GetScalarType<T[P], User_detailGroupByOutputType[P]>
    }
  >>
  ...
  export interface user_detailDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, User_detailGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUser_detailGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type booksScalarWhereWithAggregatesInput = {
    ...
    pages?: StringNullableWithAggregatesFilter | string | null
  ...
  export type borrowingScalarWhereWithAggregatesInput = {
    AND?: Enumerable<borrowingScalarWhereWithAggregatesInput>
    OR?: Enumerable<borrowingScalarWhereWithAggregatesInput>
    NOT?: Enumerable<borrowingScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    borrower_name?: StringWithAggregatesFilter | string
  ...
  export type discussScalarWhereWithAggregatesInput = {
    AND?: Enumerable<discussScalarWhereWithAggregatesInput>
    OR?: Enumerable<discussScalarWhereWithAggregatesInput>
    NOT?: Enumerable<discussScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    book_id?: IntNullableWithAggregatesFilter | number | null
    user_id?: IntNullableWithAggregatesFilter | number | null
    discuss?: StringNullableWithAggregatesFilter | string | null
  }
  ...
  export type user_detailScalarWhereWithAggregatesInput = {
    ...
    jenis_kelamin?: StringNullableWithAggregatesFilter | string | null
    usia?: IntNullableWithAggregatesFilter | number | null
    ttl?: DateTimeNullableWithAggregatesFilter | Date | string | null
  }
